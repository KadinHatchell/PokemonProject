...
public class PokePanel extends JPanel
{
	...
	public PokePanel(PokeController baseController)
	{
		...
		new String[] { "GeoDude", "Bulbasaur", "magcargo", "Blastoise", "Charizard" });
	...
	private void setupListeners()
	{
		...
		this.addMouseListener(new MouseListener()
		{
			...
			{
			//	JOptionPane.showMessageDialog(baseController.getBaseFrame(), "The mous in in!");
			}
			...
			{
			//	JOptionPane.showMessageDialog(baseController.getBaseFrame(), "The mosue was released!");
			}
			...
			{
			//	JOptionPane.showMessageDialog(baseController.getBaseFrame(), "The mouse was moved!");
			}
		...
		this.addMouseMotionListener(new MouseMotionListener()
		{
			public void mouseDragged(MouseEvent dragged)
			{
				...
				{
				updateButton.setLocation(dragged.getX() + 20, dragged.getY() + 20);
				}
			}
